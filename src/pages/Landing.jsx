  ...
  return <div className="landing-page" ref={root}>
    ...
    <main>
      <section className="landing-hero">
        <div className="landing-hero-copy"><p className="landing-kicker"><Sparkles/> Your family, in sync</p><h1>Families run<br/><span>better on FamOS.</span></h1><p>Whatever your family looks like, wherever your family is, FamOS keeps everyone running together—through every stage of family life.</p><div className="landing-hero-ctas"><button onClick={() => go(signedIn ? "today" : "signup")}>{signedIn ? "Open dashboard" : "Start free trial"}<ArrowRight/></button>{!signedIn&&<button onClick={() => go("signin")}>Sign in</button>}</div><div className="landing-trust"><span><Check/> One private household</span><span><Check/> Built for real family life</span></div></div>
