...
const features = [
  ...
  { label: "Tasks & rewards", title: "Chores that feel rewarding", copy: "Assign tasks, set points, celebrate milestones, and approve meaningful experiences.", icon: Gift, art: "tasks", tone: "pink" },
...
const stages = [
  { id: "expecting", label: "Expecting", icon: Heart, title: "Make room for what’s coming.", copy: "Coordinate appointments, preparation lists, budgets, and the people ready to support you.", artSrc: "/illustrations/stage-expecting.png", chips: ["Prenatal appointment", "Nursery checklist", "Support circle"] },
  { id: "newborn", label: "Newborn", icon: Baby, title: "Share the load in the blur.", copy: "Keep feeds, errands, meals, visitors, and small wins visible when nobody has spare brain space.", artSrc: "/illustrations/stage-newborn.png", chips: ["Bottle restock", "Meal train", "Quiet hours"] },
  { id: "school", label: "School years", icon: GraduationCap, title: "Keep every backpack on track.", copy: "See school events, activities, chores, meal plans, and pickups without chasing five separate chats.", artSrc: "/illustrations/stage-school.png", chips: ["Library books", "Soccer pickup", "Lunch plan"] },
  { id: "teen", label: "Teenagers", icon: MessageCircle, title: "More independence, less guessing.", copy: "Give teens ownership of their schedules and tasks while keeping family plans clear and respectful.", artSrc: "/illustrations/stage-teen.png", chips: ["Shared car", "Work shift", "Reward request"] },
  { id: "extended", label: "Extended family", icon: Users, title: "Stay close across households.", copy: "Coordinate care, celebrations, errands, and everyday support across generations and locations.", artSrc: "/illustrations/stage-extended.png", chips: ["Grandma’s visit", "Prescription pickup", "Family dinner"] },
];
...
export default function Landing({ signedIn = false }) {
  ...
  return <div className="landing-page" ref={root}>
    ...
    <main>
      ...
      <section className="landing-purpose" id="app-purpose"><div><p>What FamOS does</p><h2>One secure home base.</h2><span>FamOS brings shared calendars, meals, groceries, tasks, chat, budgets, and AI planning into one private family space.</span></div><div className="purpose-grid"><article><CalendarDays/><h3>Google Calendar sync</h3><p>Connect selected Google Calendars so household events appear in one shared view.</p></article><article><Users/><h3>Household collaboration</h3><p>Invite family members to chat, assign tasks, and keep plans visible.</p></article><article><LockKeyhole/><h3>Private by design</h3><p>Your home space is only visible to your household. Disconnect access anytime.</p></article></div></section>
