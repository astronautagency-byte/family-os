...
const features = [
  { label: "Calendar", title: "Every calendar. One calm view.", previewHeadline: "One shared view of everyone’s week.", copy: "Bring in the calendars you already use — school, work, sports, life. Keep some private, share the rest, and see it all at a glance.", icon: CalendarDays, art: "calendar", tone: "lilac" },
  { label: "Meals", title: "From “what’s for dinner?” to done.", previewHeadline: "From “what’s for dinner?” to done.", copy: "Plan breakfast, lunch, and dinner. Follow recipes step by step with Cook Mode, and add missing ingredients to the list without leaving the kitchen.", icon: ChefHat, art: "meals", tone: "yellow" },
  { label: "Fam AI", title: "Helpful when you ask. Safe by design.", previewHeadline: "Ask in plain words. Approve before anything changes.", copy: "Ask for meal ideas, grocery lists, or help planning the week. Fam AI suggests the next step — and waits for your OK before anything changes.", icon: Bot, art: "famai", tone: "peach" },
  { label: "Tasks", title: "Everyone knows what’s theirs.", previewHeadline: "Every task has a home and an owner.", copy: "Colour-coded lists, clear owners, and routines for the stuff that repeats. No more “did you remember…?”", icon: CheckSquare, art: "tasks", tone: "pink" },
  ...
  { label: "Shopping", title: "The list that follows you home.", previewHeadline: "From list to kitchen, without the mental load.", copy: "Quick-add on the way out the door, focus mode in the aisle, and items that move into the fridge, freezer, or pantry when you get back.", icon: ShoppingCart, art: "groceries", tone: "mint" },
];

const capabilityHighlights = [
  { title: "Calendars, your way", copy: "Connect the calendars your family already uses and decide what stays private. What you see is what you get — together.", icon: CalendarDays, tone: "lilac" },
  { title: "Recipes with Cook Mode", copy: "Follow a recipe step by step, hands-free, while it reads each stage out loud. Dinner, without the juggling.", icon: ChefHat, tone: "yellow" },
  { title: "Know what’s in the kitchen", copy: "See what’s home in the fridge, freezer, and pantry — and plan meals around what you already have.", icon: Refrigerator, tone: "pink" },
  { title: "Use-it-soon reminders", copy: "Get a gentle heads-up before things expire, and restock them in one tap from Today.", icon: BellRing, tone: "mint" },
  { title: "Photos and quick scans", copy: "Snap a photo or scan a barcode so everyone can spot the right thing on the list — no squinting at words.", icon: ShoppingCart, tone: "blue" },
  { title: "Imports you approve", copy: "Bring in lists from Apple, Google, or Microsoft — and approve every item before it lands in your home.", icon: FileInput, tone: "peach" },
  { title: "A look that’s yours", copy: "Pick a colour scheme that feels like home, with light and dark modes tuned to match.", icon: Palette, tone: "lilac" },
  { title: "Updates without clutter", copy: "Send a household note to everyone’s home page — react and move on, no new thread required.", icon: MessageCircle, tone: "yellow" },
  { title: "Fam AI, review first", copy: "Useful suggestions from meals, groceries, tasks, and calendars — always behind your confirmation.", icon: Bot, tone: "mint" },
];
    ...
    <main>
      <section className="landing-hero" ref={heroRef}>
        <motion.div className="landing-hero-copy" variants={staggerParent} initial="hidden" animate="show">
          ...
          <motion.h1 variants={fadeUp}>Family life,<br/>finally in sync.</motion.h1>
          <motion.p variants={fadeUp}>One private home for calendars, meals, groceries, tasks, chat, and a helpful bit of AI — so the whole household is on the same page.</motion.p>
      ...
      <motion.section className="landing-final" {...revealBlock}><div><p>Family life, in sync.</p><motion.h2 {...revealHeading}>Families run better<br/>on FamOS.</motion.h2><button onClick={() => go(signedIn ? "today" : "signup")}>{signedIn ? "Open FamOS" : "Start your family space"}<ArrowRight/></button></div></motion.section>
    </main>
