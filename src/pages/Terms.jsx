...
export default function Terms({ signedIn = false }) {
  return <div className="legal-page">
    ...
    <main className="legal-content">
      ...
      <section><h2>Agreement to these terms</h2><p>These Terms of Service govern your access to and use of FamOS, a family coordination app. By creating an account, subscribing, inviting household members, or using FamOS, you agree to these terms.</p></section>
      ...
      <section><h2>Billing and cancellation</h2><p>Optional features renew monthly until cancelled. The household owner can manage features, payment details, invoices, and cancellation from the billing portal. Cancellation takes effect according to the date shown there.</p></section>
      ...
      <section><h2>Cancellation and renewals</h2><p>Paid subscriptions are charged when checkout is completed and renew automatically at the selected interval. Cancellation stops future renewals but does not automatically refund the current billing period. Your access may continue until the end of the paid term unless otherwise stated in your account or required by law.</p></section>
