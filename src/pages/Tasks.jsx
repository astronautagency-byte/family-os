...
export default function Tasks(){
 const {members,memberById,tasks,addTask,toggleTask,clearTasks}=useFamily();
 ...
 return <div className="pb-28 reference-tasks"><PageHeader title="Family Task Board" illustration="tasks" subtitle="Helping your family stay perfectly in sync." action={tasks.length?<button className="page-reset-button" onClick={()=>setClearing(true)}><Trash2/> Reset</button>:null}/><div className="px-5 space-y-5">
