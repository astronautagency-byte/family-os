...
export default function Tasks(){
 ...
 return <div className="pb-28 reference-tasks"><PageHeader title="Tiny jobs, clearly owned." illustration="tasks" subtitle="So chores stop living in someone’s memory." action={tasks.length?<button className="page-reset-button" onClick={()=>setClearing(true)}><Trash2/> Reset</button>:null}/><div className="px-5 space-y-5">
