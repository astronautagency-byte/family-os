...
export default function Tasks(){
 ...
 const openEdit=(task)=>{setEditingId(task.id);setDraft({title:task.title,assigneeId:task.assigneeId||"",due:task.due||todayISO(),taskType:task.taskType||"home",listId:task.listId||null});setTaskSaveError("");setShowEditPanel(true);};
