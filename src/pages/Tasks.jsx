...
export default function Tasks(){
 ...
 const openEdit=(task)=>{setEditingId(task.id);setDraft({title:task.title,notes:task.notes||"",assigneeIds:task.assigneeIds?.length?task.assigneeIds:task.assigneeId?[task.assigneeId]:[],due:task.due||todayISO(),taskType:task.taskType||"home",listId:task.listId||null,recurring:task.recurring||''});setTaskSaveError("");setShowEditPanel(true);};
