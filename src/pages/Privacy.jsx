...
export default function Privacy({ signedIn = false }) {
  return <div className="legal-page">
    ...
    <main className="legal-content">
      ...
      <section><h2>Overview</h2><p>FamOS is a private family coordination service built for households. This policy explains what information FamOS uses, why it is needed, and the choices available to you.</p></section>
      ...
      <section><h2>Contact</h2><p>For privacy questions or requests, contact the FamOS team — we respond within one business day.</p></section>
